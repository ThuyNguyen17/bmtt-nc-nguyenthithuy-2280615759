...
# Hàm giám sát trạng thái mạng
def monitor_network():
    net_stats = psutil.net_io_counters()
    log_info("Network", f"Bytes Sent: {net_stats.bytes_sent}, Bytes Received: {net_stats.bytes_recv}")

# Hàm giám sát phần mềm đang chạy
def monitor_software():
    software_list = list(psutil.process_iter(attrs=['pid', 'name', 'username']))
...
def monitor_system():
    ...
    while True:
        ...
        log_info("System Monitor", "=" * 30)  # Dòng kẻ ngăn cách log
